import { PokemonType, Effectiveness } from './types';

type EffectivenessTable = Record<PokemonType, Record<PokemonType, Effectiveness>>;

export const TYPE_EFFECTIVENESS: EffectivenessTable = {
  'ノーマル': {
...
export function calculateSingleTypeEffectiveness(
  ...
  const effectiveness1 = TYPE_EFFECTIVENESS[attackType][defenseType1];
  const effectiveness2 = defenseType2
    ? TYPE_EFFECTIVENESS[attackType][defenseType2]
    : 1;
